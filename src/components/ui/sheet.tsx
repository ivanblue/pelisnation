  ...
  ({ side = 'right', className, children, ...props }, ref) => (
    <SheetPortal>
      ...
      <SheetPrimitive.Content ref={ref} className={cn(sheetVariants({ side }), className)} {...props}>
        {children}
        <SheetPrimitive.Close className="absolute right-4 top-4 rounded-full opacity-70 transition-opacity hover:opacity-100 bg-primary/90 hover:bg-primary focus:outline-none disabled:pointer-events-none data-[state=open]:bg-slate-100">
          <X className="h-5 w-5 p-1 text-lightgraye" />
